    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div
            ...
            <div class="space-y-4">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4" x-data="{ show: false, loading: false }"
                    @submit="loading = true">
                    @csrf

                    @if ($errors->any())
                        <div
                            class="animate-slide-up rounded-lg border border-red-200 bg-red-50 px-2.5 py-2 text-xs text-red-600 dark:border-red-900/40 dark:bg-red-900/20 dark:text-red-400">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" value="{{ old('email') }}"
                            autocomplete="username" required autofocus aria-describedby="email-error"
